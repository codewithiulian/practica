...
I'm uploading a Spanish lesson PDF from my language course. Your job is to create a quiz JSON file with exactly **[NUMBER_OF_QUESTIONS]** questions that test ONLY the material presented in this PDF.
